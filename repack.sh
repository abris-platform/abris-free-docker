...
curl --output dist/Server/sql/pg_abris_free.sql --location --header "PRIVATE-TOKEN: xs9d1-T2G4pa73QsPKaf" "https://abris.site:8091/api/v4/projects/2/repository/files/pg_abris_free.sql/raw?ref=master";
